...
class NoVisualization(object):
    ...
    def __init__(self, seq_info, dyh_frame_interval=1):
        self.frame_idx = seq_info["min_frame_idx"]
        self.last_idx = seq_info["max_frame_idx"]
        self.video_id = seq_info["video_id"]
        self.dyh_frame_interval = dyh_frame_interval
    ...
    def run(self, frame_callback):
        while self.frame_idx <= self.last_idx:
            ...
            self.frame_idx += self.dyh_frame_interval
...
class Visualization(object):
    ...
    def __init__(self, seq_info, update_ms, dyh_frame_interval=1):
